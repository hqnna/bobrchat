...
export function PreferencesTab() {
    ...
    const [inputHeightScale, setInputHeightScale] = useState(
        () => settings?.inputHeightScale ?? 0,
    );
    ...
    useEffect(() => {
        if (settings && !initializedRef.current) {
            ...
            setInputHeightScale(settings.inputHeightScale ?? 0);
        }
    }, [settings]);
    ...
    const handleSave = async (
        ...
        try {
            const updates = preferencesSchema.parse({
                ...
                inputHeightScale: inputHeightScaleVal,
            });
                ...
                <div className="mx-auto max-w-md space-y-6">
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            handleSave(option.value, boringMode, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, autoThreadNaming, useOcrForPdfs, inputHeightScale);
                                        }}
                                        className={cn(
                                            `
                    ...
                    <div className="flex items-center justify-between space-x-2">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) => {
                                ...
                                handleSave(theme, checked, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, autoThreadNaming, useOcrForPdfs, inputHeightScale);
                            }}
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onBlur={() => handleSave(theme, boringMode, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, autoThreadNaming, useOcrForPdfs, inputHeightScale)}
                    ...
                    <div className="flex items-center justify-between space-x-2">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) => {
                                ...
                                handleSave(theme, boringMode, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, checked, useOcrForPdfs, inputHeightScale);
                            }}
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between space-x-2">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) => {
                                ...
                                handleSave(theme, boringMode, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, autoThreadNaming, checked, inputHeightScale);
                            }}
                        />
                    </div>
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            handleSave(theme, boringMode, customInstructions, defaultThreadName, option.value, sendMessageKeyboardShortcut, autoThreadNaming, useOcrForPdfs, inputHeightScale);
                                        }}
                                        className={cn(
                                            `
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            handleSave(theme, boringMode, customInstructions, defaultThreadName, landingPageContent, option.value, autoThreadNaming, useOcrForPdfs, inputHeightScale);
                                        }}
                                        className={cn(
                                            `
                        flex flex-1 flex-col items-start gap-1 rounded-lg border
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-xs">
                            Control how much the input box expands based on content. "None" keeps it compact, "Lots" expands up to 24rem.
                        </p>
                        <Slider
                            id="inputHeightScale"
                            type="range"
                            ...
                            max="4"
                            step="1"
                            value={inputHeightScale}
                            onChange={(e) => {
                                const newScale = Number.parseInt(e.target.value, 10);
                                setInputHeightScale(newScale);
                                handleSave(theme, boringMode, customInstructions, defaultThreadName, landingPageContent, sendMessageKeyboardShortcut, autoThreadNaming, useOcrForPdfs, newScale);
                            }}
                            labels={["None", "Lots"]}
                        />
                    </div>
